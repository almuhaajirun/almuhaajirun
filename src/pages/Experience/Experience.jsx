...
const ExperienceSection = () => {
  const experiences = [
    {
      icon: Cpu,
      title: "Quran & Islamic Teacher",
      company: "Abu Abdillah",
      period: "Ongoing",
      description:
    ...
    },
    {
      ...
      period: "2024 - Present",
      description:
        "Working with a team of local engineers to build impactful web applications using Django. We focus on practical solutions that benefit our community and foster technical growth.",
    },
    {
      icon: Network,
      ...
      period: "2022 - Present",
      description:
        "Designing and customizing WordPress websites for individuals and organizations, blending creativity with user-friendly design to deliver elegant online experiences.",
    },
  ];
        ...
        <div className="relative container mx-auto px-6 mt-10">
          ...
          <div className="flex flex-col items-center space-y-8 mb-20">
            ...
            <p className="text-lg md:text-xl text-gray-400 font-medium tracking-wide text-center max-w-2xl">
              "Quran and Islam first. Inspiring students to memorize, understand, and live the Quran and Sunnah the Salaf way. Also building and designing for the Ummah."
            </p>
          </div>
