...
export default function Hero() {
  const words = [
  "ISLAMIC TECH EDUCATOR & USTADH",
  "TEACHING TECH WITH QURAN & ISLAMIC CORE",
  "EMPOWERING PARENTS & STUDENTS",
  "TECHNOLOGY FOR ISLAM & THE UMMAH",
  "I DO WEB DESIGN, DEVELOPMENT, AND SEO",
  "I DO GRAPHIC DESIGN AND LOGO DESIGN",
  ];

  const [code] = useState(`
const profile = {
  name: 'Abu Abdillah',
  title: 'Ustadh Abdul Lateef | Islamic Tech Educator',
  skills: [
    'Teaching', 'Quran Integration', 'React', 'NextJS', 'Express',
    'Islamic Core', 'Parent Empowerment', 'GitHub', 'Linux', 'Technology for Islam'
  ],
  mission: 'Making Islamic learning first, then tech',
  yearsOfExperience: 7, 
  inspire: function() {
    return (
      this.mission &&
      this.skills.includes('Islamic Core')
    );
  }
};
  `);
